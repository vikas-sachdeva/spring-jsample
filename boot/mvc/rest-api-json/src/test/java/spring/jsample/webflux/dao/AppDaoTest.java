...
public class AppDaoTest {
    ...
    public void getAppTest1() {
        int id = 2;
        AssertionsForInterfaceTypes.assertThat(dao.getAppById(id))
                                   .isNotNull()
                                   .extracting(Application::getId, Application::getName, Application::getStatus)
                                   .doesNotContainNull().contains(id);
    }

    @Test
    public void getAppTest2() {
        AssertionsForInterfaceTypes.assertThatExceptionOfType(NoSuchElementException.class).isThrownBy(() -> dao.getAppById(5));
    }
